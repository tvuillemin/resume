...
\cvachievement{\faCode}{Programmation}{Programmation, bases de données et déploiement}
...
\cvachievement{\faHtml5}{Systèmes}{\textit{Front-end}, \textit{back-end} and outils de construction}
\wheelchart{1.5cm}{0.5cm}{%
